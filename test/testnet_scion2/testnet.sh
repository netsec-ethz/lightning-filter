...
function testnet_up() {
    ...
    sudo ip address add 10.248.11.1/24 dev one
    sudo ip address add 10.248.12.1/24 dev one
    ...
    sudo ip address add 10.248.14.1/24 dev five
    sudo ip address add 10.248.15.1/24 dev five
    ...
    sudo ip netns exec near-0 ip route add 10.248.11.0/24 dev two via 10.248.1.1
    sudo ip netns exec near-0 ip route add 10.248.12.0/24 dev two via 10.248.1.1
    sudo ip netns exec near-0 ip route add 10.248.14.0/24 dev two via 10.248.1.1
    sudo ip netns exec near-0 ip route add 10.248.15.0/24 dev two via 10.248.1.1
    ...
    sudo ip netns exec far-0 ip route add 10.248.11.0/24 dev four via 10.248.2.1
    sudo ip netns exec far-0 ip route add 10.248.12.0/24 dev four via 10.248.2.1
    sudo ip netns exec far-0 ip route add 10.248.14.0/24 dev four via 10.248.2.1
    sudo ip netns exec far-0 ip route add 10.248.15.0/24 dev four via 10.248.2.1
    ...
    sudo ip netns exec near-1 ip route add 10.248.11.0/24 dev six via 10.248.4.1
    sudo ip netns exec near-1 ip route add 10.248.12.0/24 dev six via 10.248.4.1
    sudo ip netns exec near-1 ip route add 10.248.14.0/24 dev six via 10.248.4.1
    sudo ip netns exec near-1 ip route add 10.248.15.0/24 dev six via 10.248.4.1
    # ethernet address: LF config for peer
    ...
    sudo ip netns exec far-1 ip route add 10.248.11.0/24 dev eight via 10.248.5.1
    sudo ip netns exec far-1 ip route add 10.248.12.0/24 dev eight via 10.248.5.1
    sudo ip netns exec far-1 ip route add 10.248.14.0/24 dev eight via 10.248.5.1
    sudo ip netns exec far-1 ip route add 10.248.15.0/24 dev eight via 10.248.5.1
